/*
 * $Header: /HexenWorld/HCode/Ogre.hc 1     2/04/98 1:59p Rjohnson $
 */
/*
==============================================================================
...
void() OgreGrenadeExplode =
{
	...
	self.velocity = '0 0 0';
	self.touch = SUB_Null;
	setmodel (self, "models/s_explod.spr");
...
// set missile duration
	...
	setmodel (missile, "models/grenade.mdl");
...
local float 	ldmg;
	...
	if (side)
	{
		makevectors (self.angles);
		if (side == 1)
			SpawnMeatSpray (self.origin + v_forward*16, random(-100,100) * v_right);
		else
...
// check for gib
	if (self.health < -80)
	{
		...
		ThrowHead ("models/h_ogre.mdl", self.health);
...
/*QUAK-ED monster_ogre (1 0 0) (-32 -32 -24) (32 32 64) Ambush
