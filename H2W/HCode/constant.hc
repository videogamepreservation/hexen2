/*
 * $Header: /HexenWorld/HCode/constant.hc 67    10/02/98 6:37p Mgummelt $
 */
...
float ARTFLAG_FROZEN				= 16;	// 128
float ARTFLAG_STONED				= 32;	// 256
float ARTFLAG_DIVINE_INTERVENTION	= 64;	// 512
