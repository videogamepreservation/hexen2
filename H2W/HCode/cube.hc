/*
 * $Header: /HexenWorld/HCode/cube.hc 2     3/27/98 4:11p Nalbury $
 */
...
/*
 * $Log: /HexenWorld/HCode/cube.hc $
 * 
 * 2     3/27/98 4:11p Nalbury
 * Working on fixing up the demoness, networkwise.
 * 
