/*
 * $Header: /HexenWorld/HCode/fx.hc 4     4/23/98 5:15p Mgummelt $
 */
...
/*
 * $Log: /HexenWorld/HCode/fx.hc $
 * 
 * 4     4/23/98 5:15p Mgummelt
 * 
 * 3     3/03/98 11:16a Rmidthun
 * teleport effects moved to tempents
 * 
 * 2     2/20/98 5:08p Nalbury
 * 
