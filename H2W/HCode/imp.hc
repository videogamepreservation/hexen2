/*
 * $Header: /HexenWorld/HCode/imp.hc 9     4/20/98 2:03p Rjohnson $
 */
/*
==============================================================================
...
//			sound (self, CHAN_BODY, "imp/die.wav", 1, ATTN_NORM);
	...
	if(self.frame==$death8)
		if (self.flags & FL_ONGROUND)
		{
			...
			weapon_sound(self, "player/land.wav");
...
*/	}
	...
	{
		weapon_sound(self, "imp/fireball.wav");
...
vector punch,dir;
	...
	{  // If we are in swoop attack frames
		self.flags (-) FL_ONGROUND;
		weapon_sound(self, "imp/swoophit.wav");
...
void() stone_imp_awaken = [++ $impup7 .. $impup23]
{
	if(self.frame==$impup10)
	{
		...
		weapon_sound(self, "fx/wallbrk.wav");
